...
plt.scatter(
    x, y, c="none", s=6, edgecolor=(0.5, 0.5, 0.5), lw=0.8
)  # (0.38, 0.65, 0.87)
...
plt.annotate(
    ...
    arrowprops=dict(
        arrowstyle="->", linewidth=1.0, connectionstyle="arc3,rad=0"
    ),
)
plt.annotate(
    "",
...
p1_1 = {
    ...
    "name": "pA",
    "fwd": True,
    "opts": {"linewidth": lw, "color": col_map["black"]},
}
rbs_1_1 = {
    "type": "RBS",
    "name": "rbs_f",
