...
pA_OFF = {
    ...
    "opts": {
        "linewidth": lw,
        "color": lighten_color(col_map["black"], off_fac),
    },
}
pB_OFF = {
    "type": "Promoter",
...
p1_OFF = {
    ...
    "name": "p3",
    "fwd": True,
    "opts": {"linewidth": lw, "color": lighten_color(col_map["red"], off_fac)},
}
p2_OFF = {
    "type": "Promoter",
    "name": "p4",
    "fwd": True,
    "opts": {"linewidth": lw, "color": lighten_color(col_map["blue"], off_fac)},
}
p3_OFF = {
    "type": "Promoter",
    "name": "p5",
...
p4_1_OFF = {
    ...
    "opts": {
        "linewidth": lw,
        "color": lighten_color(col_map["orange"], off_fac),
    },
}
p4_2_OFF = {
    "type": "Promoter",
...
arc1 = {
    ...
    "from_part": g1_ON,
    "to_part": p1_OFF,
    "opts": {"color": col_map["red"], "linewidth": lw},
}
arc2 = {
    "type": "Repression",
    "from_part": g2_ON,
    "to_part": p2_OFF,
    "opts": {"color": col_map["blue"], "linewidth": lw},
}
arc3 = {
    "type": "Repression",
    "from_part": g3_ON,
...
arc4 = {
    ...
    "from_part": g4_ON,
    "to_part": p4_1_OFF,
    "opts": {"color": col_map["orange"], "linewidth": lw, "arc_height": 20},
}
arc5 = {
    "type": "Repression",
    "from_part": g4_ON,
