...
arc1 = {
    ...
    "opts": {
        ...
        "arc_height_start": 8,
        "arc_height_const": 9,
        "arc_height_spacing": 1.1,
        "arc_height_end": 7.5,
    },
}
arc2 = {
    "type": "Repression",
    "from_part": parts["g1"][0],
    "to_part": parts["pA1"][0],
    "opts": {
        "color": col_map["green"],
        "linewidth": 1.0,
...
plt.subplots_adjust(
    hspace=0.04, wspace=0.04, left=0.01, right=0.99, top=0.99, bottom=0.01
)
