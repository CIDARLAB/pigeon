...
def sbol_recombinase1(
    ...
    # Draw the site
    p1 = Polygon(
        [(start, y_lower), (start, y_upper), (end, 0)],
        edgecolor=(0, 0, 0),
        facecolor=color,
        linewidth=linewidth,
        zorder=11,
...
d1 = {
    ...
    "fwd": True,
    "opts": {
        "color": col_map["purple"],
        "color2": dark(col_map["purple"]),
        "x_extent": 16,
        "y_extent": 12,
    },
}
...
start, end = dr.renderDNA(
    ax_dna1, design1, part_renderers, regs=reg1, reg_renderers=reg_renderers
)
...
# Render the array
start, end = dr.renderDNA(
    ax_dna2, design2, part_renderers, regs=reg2, reg_renderers=reg_renderers
)
...
# Render the array
start, end = dr.renderDNA(
    ax_dna3, design3, part_renderers, regs=reg3, reg_renderers=reg_renderers
)
