...
def main():
    ...
    parser.add_argument(
        ...
        dest="input",
        required=True,
        help='"p.gray p.lightblue i.lightred r.green c.orange t.purple -t.black -c.yellow -p.yellow"',
        metavar="string",
    )
    parser.add_argument(
        "-output", dest="output", required=False, help="output pdf filename"
    )
    ...
    dr = dpl.DNARenderer(
        linewidth=1.15, backbone_pad_left=3, backbone_pad_right=3
    )
