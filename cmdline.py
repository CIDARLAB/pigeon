...
def main():
    ...
    parser.add_argument(
        "pigeon_script",
        help="enter the path to the pigeon script text file to be parsed",
    )
    parser.add_argument(
        "-location",
        "--location",
    ...
    parser.add_argument(
        "-format",
        "--format",
        help="enter the format you want the image to be saved in \n i.e. -image_type=pdf \n options are svg, pdf, and png. Default is svg.",
    )
    parser.add_argument(
        "-name",
        "--name",
        help="enter a name for the design that is being generated \n i.e. -name=my_image_name",
    )
